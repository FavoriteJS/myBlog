...
module.exports = {
  ...
  output: {
    path: './dist',//输出路径
    filename: isProd() ? '[name].[chunkhash:8].js' : '[name].js', //输出文件名
  ...
  module: {
    loaders: [{ //文件模块转换规则
      ...
      loader: ExtractTextPlugin.extract('style-loader', 'css-loader', { // 使用css-loader  require() 加载scss文件
        publicPath: '.'
      })
    }, {
      test: /\.(png|jpg)$/,
